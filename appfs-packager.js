...
if (process.argv.length < 3) {
	console.log("usage: "+path.basename(__filename,".js")+" <appfolder to package>");
	...
	walk(appFolder,function(err,files) {
		if (err) {
			...
			if (config.archiver2 == "bundle") {
				...
				var bundle = require("./node_modules/appjs-package2/appjs-package2-2").Package();
				...
				bundle.addFiles(files,function(err) {
					if (err) {
						...
						if (config.zipPackage == "gz") {
							...
							var bundle3 = require("./node_modules/appjs-package2/appjs-package2-2").Package();
